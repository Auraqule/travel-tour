...
export function ExploreSection() {
  return (
    <ExploreSectionContainer name="Explore">
      ...
      <SectionInfo>
        check out our tour packages and find out more about the places we will
        visit together on this journey to the beautifull places of Africa,
        exploring so many historical and amazing locations with the group and
        having so much fun.
      </SectionInfo>
